...
const ProdukTas = () => {
  ...
  const handleCreate = async (e) => {
    ...
    if (
      ...
      try {
        ...
        await axios.post(
          "http://localhost:8080/produk-tas/",
          formData,
          {
            formData,
          },
  ...
  const handleUpdate = async (event) => {
    ...
    try {
      ...
      const putData = await axios.put(
        `http://localhost:8080/produk-tas/update/${id}`,
  ...
  const handleDelete = async (event) => {
    ...
    try {
      const deleteData = await axios.delete(
        `http://localhost:8080/delete/produk-tas/${id}`
      );
      Swal.fire({
        icon: "success",
        title: "Success",
  ...
  return (
    <div className="body-flex">
      <h1 className="py-1">Data Produk Tas</h1>
      <div>
        <Button
          className="mb-3"
          variant="primary"
