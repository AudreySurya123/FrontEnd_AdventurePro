...
const ProdukTrackingPool = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("http://localhost:8080/produk-trackingpool/");
  ...
  const handleCreate = async (e) => {
    ...
    if (
      ...
      try {
        ...
        await axios.post(
          "http://localhost:8080/produk-trackingpool/",
          formData,
          {
            formData,
          },
        ...
        navigate("/admin/produk-trackingpool");
  ...
  const handleUpdate = async (event) => {
    ...
    try {
      ...
      const putData = await axios.put(
        `http://localhost:8080/produk-trackingpool/update/${id}`,
  ...
  const handleDelete = async (event) => {
    ...
    try {
      const deleteData = await axios.delete(
        `http://localhost:8080/delete/produk-trackingpool/${id}`
      );
      Swal.fire({
        icon: "success",
        title: "Success",
  ...
  return (
    <div className="body-flex">
      <h1 className="py-1">Data Produk Tracking Pool</h1>
      <div>
        <Button
          className="mb-3"
          variant="primary"
...
export default ProdukTrackingPool;